...
migdep_init = dd.read_csv("data/raw/FD_MIGGCO_2020.csv",sep=";",dtype={"COMMUNE":str,"IPONDI":float,"DRAN":str})
# len(migdep_init)
...
count_init = migdep.groupby(["DRAN","DRACT"])["IPONDI"].sum().reset_index().compute()
...
new1.to_csv("data/mig-res-2020.csv",index=False)